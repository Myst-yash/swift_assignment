...
let favouriteBook = Book(title: "Harry Potter", author: "J.K. Rowling", pages: 879, price: 2999)
...
let firstLaptop = Laptop(screenSize: 24, yearPurchased: 2023)
let secondLaptop = Laptop(repairCount: 3400, yearPurchased: 2021)
/*:
...
let height = Height(heightInInches: 65)
