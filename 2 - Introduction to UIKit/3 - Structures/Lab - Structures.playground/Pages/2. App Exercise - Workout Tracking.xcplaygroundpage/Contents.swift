...
firstRun = RunningWorkout(distance: 2_396, time: 15.3, elevation: 94)
print("We go a distance of \(firstRun.distance) meters in \(firstRun.time) minutes, and gain \(firstRun.elevation) meters of elevation.")
