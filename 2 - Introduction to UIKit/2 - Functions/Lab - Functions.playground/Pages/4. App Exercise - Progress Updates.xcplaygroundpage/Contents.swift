...
func pacing(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double){
    var currentPace = currentDistance / currentTime
    var goalPace = totalDistance / goalTime
...
pacing(currentDistance: 800, totalDistance: 1000, currentTime: 9, goalTime: 10)
pacing(currentDistance: 900, totalDistance: 1000, currentTime: 8, goalTime: 10)
/*:
