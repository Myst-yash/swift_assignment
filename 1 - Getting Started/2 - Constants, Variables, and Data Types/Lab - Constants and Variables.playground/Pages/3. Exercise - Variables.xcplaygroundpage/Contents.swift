...
print("Yes, the above code compiled successfully without showing any error and this happened because schooling is a variable which can be changed futher. Thus giving it's name variable.")
