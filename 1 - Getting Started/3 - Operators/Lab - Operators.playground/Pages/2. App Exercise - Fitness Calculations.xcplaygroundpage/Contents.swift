...
//Yes it does differ from the previous output because now we assigned the values to be of double explicit type. So now they are returning the value in double type with a decimal.
