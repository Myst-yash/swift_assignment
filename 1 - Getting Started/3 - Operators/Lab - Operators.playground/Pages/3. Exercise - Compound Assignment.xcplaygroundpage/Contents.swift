 ...
 */
var pennyBank = 0
pennyBank += 10             //Your neighbor gives you 10 dollars for mowing her lawn
print(pennyBank)

pennyBank += 20             //You earn 20 more dollars throughout the week doing odd jobs
print(pennyBank)

pennyBank /= 2              //You spend half your money on dinner and a movie
print(pennyBank)

pennyBank *= 3              //You triple what's left in your penny bank by washing windows
print(pennyBank)

pennyBank -= 3              //You spend 3 dollars at a convenience store
print(pennyBank)
